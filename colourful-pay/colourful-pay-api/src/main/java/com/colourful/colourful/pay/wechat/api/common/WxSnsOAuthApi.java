...
import com.colourful.colourful.pay.wechat.api.sns.domain.WxSnsOAuth2AccessToken;
import com.colourful.colourful.pay.wechat.api.sns.domain.WxSnsOAuthUserInfo;
import com.colourful.colourful.pay.wechat.api.sns.domain.WxSnsUserInfo;
...
public class WxSnsOAuthApi extends WxAbstractApi {
    ...
    public WxSnsUserInfo oAuth2UserInfo(String openId, String accessToken, String lang)
        ...
        try {
            BeanUtils.copyProperties(oAuthUserInfo, userInfo);
