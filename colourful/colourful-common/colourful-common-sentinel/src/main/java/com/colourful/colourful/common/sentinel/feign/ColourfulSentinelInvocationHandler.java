 ...
 */
@Slf4j
public class ColourfulSentinelInvocationHandler implements InvocationHandler {
	...
	ColourfulSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			ColourfulSentinelInvocationHandler other = (ColourfulSentinelInvocationHandler) obj;
